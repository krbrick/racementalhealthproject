...
sdat1 <- Underlying_Cause_of_Death_1999_2020_3_
sdat <- suicide.data
...
library(dplyr)
#sdat1 <- sdat1 %>% 
   # mutate("CountyCode" = as.character(sdat1$`CountyCode`),
  #CrudeRate25 = round(Death25/Population25*100000,2))
#merge.d <- inner_join(d,sdat1)
#Remove Notes column
#mutate 09015 county code to 9015

merge.vt.25 <- left_join(merge1, vt.vars.census)

merge.pa.25 <- left_join(merge1, pa.vars.census)

merge.ny.25 <- left_join(merge1, ny.vars.census)

merge.nh.25 <- left_join(merge1, nh.vars.census)

merge.ma.25 <- left_join(merge1, ma.vars.census)
